...
{{?assigneesListDescription}} - массив описания задач (начало), внутри него:
...
Для описание задач с разбивкой по пулам используйте массив:
{{?assigneesListDescriptionByPool}} - начало массива
{{/assigneesListDescriptionByPool}} - окончание массива
Внутри него используйте те же хэштэги элементов диаграммы и связанных с ними объектов (роли, элементы архитектуры и т.д.)

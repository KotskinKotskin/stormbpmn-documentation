...
<img src="@source/features_new_storm/create-group-1.png" alt="image"></li>
<li>Двойным кликом на группу откройте меню редактирования группы:
<img src="@source/features_new_storm/create-group-2.png" alt="image"></li>
...
<img src="@source/features_new_storm/create-group-3.png" alt="image"></p>
</div>
<ol start="5">
<li>
...
<li>
<p>Используйте фильтр и перемещайтесь по иерархии кликом на симол лупы с картой.<br>
<img src="@source/features_new_storm/create-group-4.png" alt="image"></p>
</li>
</ol>

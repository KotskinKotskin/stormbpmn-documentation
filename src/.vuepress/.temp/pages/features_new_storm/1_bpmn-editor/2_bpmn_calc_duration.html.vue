<template><div><h1 id="расчет-длительности-сценария" tabindex="-1"><a class="header-anchor" href="#расчет-длительности-сценария"><span>Расчёт длительности сценария</span></a></h1>
...
<img src="@source/features_new_storm/1_bpmn-editor/error-check-4.png" alt="image"></p>
</div>
</div></template>

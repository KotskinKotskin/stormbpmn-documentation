...
<h2 id="раздвилка-или" tabindex="-1"><a class="header-anchor" href="#раздвилка-или"><span>Раздвилка ИЛИ</span></a></h2>
...
<p>Развилка №2 никогда не пропустит процесс дальше, т.к. ждёт 3 токена на вход (потому что 3 входящих потока), но ИЛИ развилка между Task 2 и Task 3 запустит токен только по одному из потоков. И</p>

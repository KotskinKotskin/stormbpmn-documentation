...
<p>Смотрите <RouteLink to="/docs/real-life-scenarios/">примеры из реальной жизни</RouteLink>, чтобы узнать больше.</p>
...
<img src="@source/docs/sign-in.png" alt="image"></p>
</li>
<li>
<p>Создайте процесс:<br>
<img src="@source/docs/create-process.png" alt="image"></p>
</li>
<li>
<p>Используйте <RouteLink to="/docs/bpmn/">BPMN</RouteLink>:<br>
<img src="@source/docs/model-process.png" alt="image"></p>
</li>
<li>
<p>Сохраните процесс:<br>
<img src="@source/docs/save-process.png" alt="image"></p>
</li>
<li>
<p>Укажите имя:<br>
<img src="@source/docs/enter-name.png" alt="image"></p>
</li>
<li>
<p>Поделись ссылкой:<br>
<img src="@source/docs/share-process.png" alt="image"></p>
</li>
<li>
<p>Укажите анонимный доступ:<br>
<img src="@source/docs/anon-share.png" alt="image"></p>
</li>
</ol>
<div class="hint-container tip">

...
<p class="hint-container-title">Наш главный приоритет</p>
...
<li>Сформировать ТЗ на автоматизацию бизнес-процессов;</li>
<li>Обеспечить быструю и качественную адаптацию новых сотрудников;</li>
</ul>
<p>Смотрите <RouteLink to="/start-from/real-life-scenarios/">примеры из реальной жизни</RouteLink>, чтобы узнать больше.</p>
...
<img src="@source/start-from/sign-in.png" alt="image"></p>
</li>
<li>
<p>Создайте процесс:<br>
<img src="@source/start-from/create-process.png" alt="image"></p>
</li>
<li>
<p>Используйте <RouteLink to="/start-from/bpmn/">BPMN</RouteLink>:<br>
<img src="@source/start-from/model-process.png" alt="image"></p>
</li>
<li>
<p>Сохраните процесс:<br>
<img src="@source/start-from/save-process.png" alt="image"></p>
</li>
<li>
<p>Укажите имя:<br>
<img src="@source/start-from/enter-name.png" alt="image"></p>
</li>
<li>
<p>Поделись ссылкой:<br>
<img src="@source/start-from/share-process.png" alt="image"></p>
</li>
<li>
<p>Укажите анонимный доступ:<br>
<img src="@source/start-from/anon-share.png" alt="image"></p>
</li>
</ol>
<div class="hint-container tip">
<p class="hint-container-title">Вот и все</p>

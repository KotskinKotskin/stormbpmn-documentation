...
<blockquote>
<p><strong>LDAP</strong> помечен как устаревший способ авторизации и не рекомендуется к использованию в новых установках. <strong>Крайне</strong> рекомендуем освоить Keycloak, сильно сэкономите силы и время на поддержку. Инструкции по настройке LDAP предоставляются через менеджера.</p>
</blockquote>
<hr>

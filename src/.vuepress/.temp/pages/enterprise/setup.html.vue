...
<p>Stormbpmn поставляется как docker-контейнер из приватного репозитория, который включается в себя и front, и back. Установка заключается в правильном указании .ENV-перменных внутрь контейнера, поднятии смежных контейнеров (если необходимо), и манупляции в административном интерфейсе.</p>
...
<li>Создайте пользователя с полными правами доступа к базе. Запоните логин и пароль.</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Теперь учетная запись является административной и все последующие учетные записи в этой команде тоже будут административными. Не используйте эту учетную запись в работе.</p>
...
<li><strong>MINIO_ACCESSKEY</strong> - название учетной записи с провами на создание бакетов и запись файлов.</li>
<li><strong>MINIO_SECRETKEY</strong> - пароль учетной записи с провами на создание бакетов и запись файлов.</li>
...
<p>Мы предоставляет метрики в формате Prometeus, <RouteLink to="/support/">подробности о подключении и обеспечении резервного копирования</RouteLink>.</p>
...
<ul>
<li>Установите Mautic на последий релиз версии v.4.xxx (например v.4.2.1) из <a href="https://hub.docker.com/r/mautic/mautic" target="_blank" rel="noopener noreferrer">докера<ExternalLinkIcon/></a></li>
...
<li>Создайте шаблоных красивых писем с использованием плейсхолдеров, вставляйте текст в скобках на места, куда система подставит актуальные значения</li>
</ul>
<table>
<thead>
<tr>
...
<ul>
<li><strong>simpleEmailEnabled</strong> - включен простой отправитель писем. (изменения применяется ТОЛЬКО после перезагрузки приложения)</li>
...
<p>Будет отсылаться информация о изменении версии, о комментариях, о новой задаче на согласовании, о завершении согласований.</p>

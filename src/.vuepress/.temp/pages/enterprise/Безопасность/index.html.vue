...
<h4 id="пример-создания-и-настроики-oauth2-клиента-в-keycloak-26-0-7" tabindex="-1"><a class="header-anchor" href="#пример-создания-и-настроики-oauth2-клиента-в-keycloak-26-0-7"><span>Пример создания и настройки Oauth2-клиента в Keycloak 26.0.7</span></a></h4>
<ol>

...
## 🏗️ Переменные окружения безопасности
...
::: warning ⚠️ Рекомендации по безопасности
...
## 🎛️ Настройки в административной панели
...
::: warning ⚠️ Только для тестирования
...
-   **[⚙️ Конфигурация](README.md)** - полный справочник настроек

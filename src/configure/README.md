...
| **LICENSE_KEY_V2**         | Лицензионный ключ Enterprise v2                   | Получите по полному коду активации инсталляции | ✅ для лицензированной работы |
...
1. **Основные параметры**:
    ...
    перезапустите все экземпляры. Без подходящего ключа бэкенд может запуститься в
    заблокированном лицензионном режиме, достаточном для входа владельца и восстановления
    через `/admin-onboarding`, но не для обычной работы пользователей.

...
1. **Основные параметры**:
    ...
    Без `LICENSE_KEY_V2` бэкенд может запуститься в заблокированном лицензионном режиме,
    достаточном для входа владельца и восстановления через `/admin-onboarding`, но не для
    обычной работы пользователей.
...
| Ошибки лицензии           | Нет или неверен `LICENSE_KEY_V2` | Сверьте полный код на `/admin-onboarding`; порядок действий см. в [разделе о восстановлении лицензии](/operation/License.md#диагностика-и-восстановление) |

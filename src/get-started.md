...
| **База данных (PostgreSQL 12+)**                      | Хранение всей информации. Кодировка **UTF8** + расширения **pgvector**, **pg_trgm**, **pgcrypto**, **uuid-ossp**, **hstore** — см. [требования](/install/README.md) |

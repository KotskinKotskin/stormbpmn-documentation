...
5. Откройте [http://localhost:8081/admin-onboarding](http://localhost:8081/admin-onboarding),
...
- Дождитесь перезапуска приложения и проверьте лицензию на странице
  ...
  проверьте вход лицензированного обычного пользователя. Без ключа бэкенд может запуститься
  в заблокированном режиме только для восстановления владельцем через `/admin-onboarding`.

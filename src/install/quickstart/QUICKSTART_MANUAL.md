...
Для продолжения настройки каждой Enterprise-инсталляции необходим отдельный ключ v2:
...
3. Добавьте ключ в переменную окружения **`LICENSE_KEY_V2`**. Переменная `LICENSE_KEY` и
   лицензии v1 больше не принимаются.

...
3. Настройте порты для доступа к приложению: 8081 (веб-интерфейс) и 8082 (API)
...
4. Перезапустите контейнер, дождитесь успешных health checks и проверьте статус лицензии на
   `/admin-onboarding`.

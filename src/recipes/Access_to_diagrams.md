...
Если автор диаграммы и читатель диаграммы находятся в одной команде, то при проверке доступа будут проверены права **читателя** и он получит доступ **как минимум на чтение**. Какие именно права бывают у участника команды и как они настраиваются группами — см. [Роли и права участников команды](./Roles_and_privileges.md).
...
Если участнику команды запретили доступ на чтение к "Папкам", то он не увидит структуру папок. Подробнее о запретах и наследовании — в разделе [Ограничение доступа к папкам и вики](./Roles_and_privileges.md#ограничение-доступа-к-папкам-и-вики).
...
-   **[Роли и права участников команды](./Roles_and_privileges.md)** — права участника, группы прав и полный список привилегий

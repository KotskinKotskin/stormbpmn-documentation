...
**Результат**: бэкапы автоматизированы, restore протестирован, `LICENSE_KEY_V2` сохраняется в
защищённом хранилище, а DR-процедуры включают сверку кода активации и проверку лицензированного
доступа обычного пользователя.

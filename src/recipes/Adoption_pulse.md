...
![События за день: пилообразный график — условные данные](/recipes/adoption-pulse/raw-events.svg)

![Авторы за 28 дней: устойчивый тренд — условные данные](/recipes/adoption-pulse/authors-trend.svg)
...
![Аудитория и авторы за скользящие 28 дней — условные данные](/recipes/adoption-pulse/audience.svg)

![Недельная аудитория и авторы — условные данные](/recipes/adoption-pulse/weekly.svg)

![Доля недельной аудитории в аудитории за 28 дней — условные данные](/recipes/adoption-pulse/stickiness.svg)
...
![Удержание когорт по месяцу первого вклада — условные данные](/recipes/adoption-pulse/cohorts.svg)
...
![Пришедшие, активированные и вернувшиеся новички — условные данные](/recipes/adoption-pulse/newcomers.svg)
...
![Структура аудитории за 28 дней — условные данные](/recipes/adoption-pulse/tiers.svg)
...
![Ядро и все авторы за 14 дней — условные данные](/recipes/adoption-pulse/core.svg)
...
![Количество моделей в базе — условные данные](/recipes/adoption-pulse/models.svg)

![Доля моделей с сохранённой версией за 90 дней — условные данные](/recipes/adoption-pulse/alive.svg)
...
![Комментаторы и решения по согласованиям — условные данные](/recipes/adoption-pulse/collaboration.svg)
...
![Пользователи ИИ-чата — условные данные](/recipes/adoption-pulse/ai.svg)

![Доля авторов, использующих ИИ — условные данные](/recipes/adoption-pulse/ai-share.svg)
...
![Возвращаемость после рассылки и в обычную неделю — условные данные](/recipes/adoption-pulse/campaign.svg)

...
| Порог для совпадения слов | **0.5** | Минимальная близость для фрагментов, найденных по точным словам (keyword-поиск). Фильтрует «шум» в словесной ветке гибридного поиска. | нет |

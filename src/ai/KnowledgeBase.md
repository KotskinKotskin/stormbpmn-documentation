...
| Порог для совпадения слов | **0.82** | Минимальная близость для фрагментов, найденных по точным словам (keyword-поиск). Фильтрует «шум» в словесной ветке гибридного поиска. | нет |
...
::: tip Гибридный поиск и порог слов
Параметр **Порог для совпадения слов** работает только при включённом **гибридном поиске**. Он отсеивает фрагменты, которые совпали по словам, но слишком далеки по смыслу (низкий косинус). Это предотвращает попадание в ответ «мусора», найденного только по совпадению аббревиатур или терминов, но нерелевантного по контексту.
:::

...
| 4.1 | **Получить ключ под свою инсталляцию**        | С версии 6.6.XXXX — см. [«Активация инсталляции»](/operation/License.md#активация-инсталляции) |
...
::: danger Версия ≥ 6.6.XXXX — нужен новый лицензионный ключ
Ключ выдаётся под конкретную инсталляцию, ранее выданные ключи не подойдут. Запросите ключ
**до** обновления: код активации возьмите на странице `/admin-onboarding` работающей системы.

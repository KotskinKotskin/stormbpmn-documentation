...
::: tip Расчёт ёмкости лицензии
Для лицензий типов **CONCURRENT** и **HYBRID** одна лицензионная единица покрывает до **100** одновременных пользователей в сессии (ранее — 15).

Это означает, что при покупке, например, 1 конкурентной лицензии, система поддерживает до 100 одновременных подключений.
:::

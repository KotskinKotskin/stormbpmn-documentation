...
::: tip Расчёт ёмкости сессии
Для лицензий типов **CONCURRENT** и **HYBRID** расчётное количество пользователей, приходящихся на одну сессию, увеличено с 15 до **100**.

Это означает, что одна конкурентная лицензия теперь покрывает до 100 одновременных подключений пользователей в рамках одной сессии, что существенно повышает эффективность использования лицензий при высокой нагрузке.
:::

...
- **[Self-hosted LLM на vLLM](../configure/VLLM.md)** — как развернуть выбранную модель на vLLM (compose, разбор флагов, тюнинг производительности)
- **[AI-ассистент (чат)](../configure/AI_CHAT.md)** — подключение модели к Storm и настройка поведения чата

...
База знаний требует расширение **pgvector** в PostgreSQL — без него бэкенд не запустится. Стандартный образ `postgres` его не содержит: используйте `pgvector/pgvector:pg17` или установите pgvector в свою сборку/DBaaS. Подробнее — [«Требования к PostgreSQL»](/install/README.md).
:::

...
<nav class="table-of-contents"><ul><li><router-link to="#редактор-bpmn">Редактор BPMN</router-link><ul><li><router-link to="#оверлеи">Оверлеи</router-link></li><li><router-link to="#элементы-архитектуры">Элементы архитектуры</router-link></li><li><router-link to="#_3-типа-представлении">3 типа представлений</router-link></li><li><router-link to="#обеспечение-удобства-работы">Обеспечение удобства работы</router-link></li></ul></li><li><router-link to="#описание-задач">Описание задач</router-link></li><li><router-link to="#оргструктура">Оргструктура</router-link><ul><li><router-link to="#загрузка-из-csv">Загрузка из CSV</router-link></li></ul></li><li><router-link to="#группы-процессов">Группы процессов</router-link></li><li><router-link to="#регламенты">Регламенты</router-link></li><li><router-link to="#версионирование">Версионирование</router-link></li><li><router-link to="#комментирование">Комментирование</router-link></li><li><router-link to="#графы">Графы</router-link></li><li><router-link to="#согласование">Согласование</router-link></li><li><router-link to="#импорт-процессов">Импорт процессов</router-link></li><li><router-link to="#экспорт-процессов">Экспорт процессов</router-link></li><li><router-link to="#поиск-процессов">Поиск процессов</router-link></li><li><router-link to="#элементы-архитектуры-1">Элементы архитектуры</router-link><ul><li><router-link to="#загрузка-из-csv-1">Загрузка из CSV</router-link></li></ul></li><li><router-link to="#связь-процессов">Связь процессов</router-link></li><li><router-link to="#сравнение-as-is-и-to-be">Сравнение AS-IS и TO-BE</router-link></li><li><router-link to="#обеспечение-качества">Обеспечение качества</router-link><ul><li><router-link to="#оценка-качества">Оценка качества</router-link></li><li><router-link to="#проверка-токена">Проверка токена</router-link></li></ul></li><li><router-link to="#папки">Папки</router-link></li></ul></nav>
<h2 id="редактор-bpmn" tabindex="-1"><a class="header-anchor" href="#редактор-bpmn"><span>Редактор BPMN</span></a></h2>
<h3 id="оверлеи" tabindex="-1"><a class="header-anchor" href="#оверлеи"><span>Оверлеи</span></a></h3>
<h3 id="элементы-архитектуры" tabindex="-1"><a class="header-anchor" href="#элементы-архитектуры"><span>Элементы архитектуры</span></a></h3>
<h3 id="_3-типа-представлении" tabindex="-1"><a class="header-anchor" href="#_3-типа-представлении"><span>3 типа представлений</span></a></h3>
